 ...
 * Generated at: 2023-06-22 21:55:49 UTC
...
public final class FlightDetails_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    String sql = "SELECT f.*, t.trip_miles FROM Flights f JOIN Trips t ON f.trip_id = t.trip_id WHERE f.flight_id = ?";
    ...
    if (rs.next()) {
        ...
        int trip_miles = rs.getInt("trip_miles");
            output += "dept_datetime: " + dept_datetime + ", arrival_datetime: " + arrival_datetime + ", flight_miles: " + flight_miles + ", trip_id: " + trip_id + ", trip_miles: " + trip_miles;
    } else {
        output = "No flight details found for the given flight ID.";
    }
